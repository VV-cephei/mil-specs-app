<template>
  <div class="smt-toc-wrapper" ref="wrapperRef" :style="placeholderStyle">
    <nav 
      ref="navRef"
      class="smt-toc"
      :class="{ 
        'smt-toc--fixed': isFixed,
        'smt-toc--mobile-open': isMobileOpen 
      }"
...
@media (max-width: 768px) {
  ...
  .smt-toc--mobile-open .toc-mobile-toggle {
    position: absolute;
    top: var(--space-2);
    right: var(--space-4);
  }
  
  .smt-toc--mobile-open .toc-list {
